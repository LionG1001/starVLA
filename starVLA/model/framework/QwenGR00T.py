...
class Qwen_GR00T(baseframework):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.action_model: FlowmatchingActionHead = get_action_model(config=self.config).bfloat16()  # 修复后续引用
    ...
    def forward(
        ...
        **kwargs,
        ...
        with torch.autocast("musa:0", dtype=torch.bfloat16):
...
if __name__ == "__main__":
    ...
    args.config_yaml = "starVLA/config/training/starvla_cotrain_libero.yaml"
    ...
    device = torch.device("musa:0" if torch.cuda.is_available() else "cpu")
